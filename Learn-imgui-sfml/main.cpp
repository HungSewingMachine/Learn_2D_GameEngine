...
int main(int argc, char* argv[])
{
    ...
    sf::CircleShape circle{ circleRadius, (size_t)circleSegments };
    ...
    // setup the text object that will be drawn to the screen
    ...
    while (window.isOpen())
    {
        ...
        // Set the circle properties, because they may have been update with the ui
